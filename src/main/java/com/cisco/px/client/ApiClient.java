...
public class ApiClient {
    ...
    private String basePath = "https://api-cx.cisco.com/px";
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://cloudsso.cisco.com/as/token.oauth2?";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api-cx.cisco.com/px

...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.cisco.px.client.model.ContractInfo.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.cisco.px.client.model.ContractResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.cisco.px.client.model.ContractsErrorResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.cisco.px.client.model.DataPaginationResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.cisco.px.client.model.Reason.CustomTypeAdapterFactory());
